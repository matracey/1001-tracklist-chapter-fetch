...
class TestCLI(unittest.TestCase):
    ...
    def test_main_success_path(self, mock_save, mock_generate, mock_scraper, mock_validate):
    ...
    def test_main_scraping_error(self, mock_scraper, mock_validate):
        ...
        mock_scraper_instance = MagicMock()
        mock_scraper_instance.get_tracklist.side_effect = ScrapingError("Scraping failed")
        mock_scraper.return_value = mock_scraper_instance
